...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 py-4 overflow-x-hidden">
      ...
      <div
        className={`bg-primary/90 text-white cursor-pointer z-10 px-4 shadow-gmbf shadow-primary/80 py-1 rounded-full font-semibold fixed bottom-10 right-2 ${top ? "" : "hidden"
          }`}
        onClick={() => {
